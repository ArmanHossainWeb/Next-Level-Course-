...
| Big-O        | বাংলা অর্থ | কীভাবে বুঝবে                   |
| ------------ | ---------- | ------------------------------ |
| **O(1)**     | স্থির সময়  | কাজ input এর উপর নির্ভর করে না |
| **O(n)**     | রেখাগত সময় | সব এলিমেন্ট একবার করে দেখা     |
| **O(n²)**    | বর্গ সময়   | nested loop                    |
| **O(n + m)** | দুই ইনপুট  | আলাদা দুই লুপ, add হবে         |
